...
export default function Services() {
  return (
    <section id="servicios" className="relative py-24 lg:py-32 bg-cream">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {services.map((s, i) => (
            <motion.div
              ...
              className="group relative p-8 rounded-3xl bg-gradient-to-br from-agro-50 to-cream border border-agro-200 hover:border-agro-700 hover:shadow-xl transition-all"
            >
              <div className="flex items-start justify-between mb-6">
                <div className="w-14 h-14 rounded-2xl bg-agro-700 group-hover:bg-agro-800 flex items-center justify-center text-cream transition">
